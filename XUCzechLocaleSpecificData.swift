...
func _loadCertificateChainAndPrivateKey(from rawData: Data, andPassword password: String) throws -> ([SecCertificate], SecKey)
{
...
public final class XUCzechLocaleSpecificPreferencesData: NSObject, NSCoding
{
    ...
    public final class EET: NSObject, NSCoding
    {
        ...
        public final class Certificate: NSObject, NSCoding
        {
            ...
            public init?(coder aDecoder: NSCoder)
            {
                guard let data = aDecoder.decodeObject(forKey: Keys.CertificateData) as? Data,
            ...
            {
                //let sign = try? CC.RSA.sign(data, derKey: self.privateKey as! Data, padding: .pss, digest: .sha256, saltLen: 256)
        ...
        public var cashRegisterID: String = "Zařízení 1"
...
extension XUCzechLocaleSpecificPreferencesData: NSCopying
{
    ...
    public func copy(with zone: NSZone? = nil) -> Any
    {
        ...
        return XUCzechLocaleSpecificPreferencesData(taxFormVariables: variables, eetData: eetData)
    }
}
...
extension XUCzechLocaleSpecificPreferencesData.EET.Certificate: NSCopying
{
    ...
    public func copy(with zone: NSZone? = nil) -> Any
    {
        return try! XUCzechLocaleSpecificPreferencesData.EET.Certificate(rawData: self.rawData, password: self.password)
    }
}
